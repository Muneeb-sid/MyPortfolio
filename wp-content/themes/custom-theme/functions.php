...
function create_posttype() {
    ...
    function CreatetestimonialsShortcode()
    {
    $args = array(
    ...
    <div id="owl_custom11" class="owl-carousel owl-theme">
    ...
    add_shortcode( 'testimonialsshortcode', 'CreatetestimonialsShortcode' );